...
public class UserController {
	...
	public String login(User user,HttpServletResponse response,HttpServletRequest request
		...
		System.out.println(CryptographyUtil.md5(user.getPassword(), "huangqiuping"));
		SecurityUtils.getSubject().getSession().setAttribute("login_type", "user_login");
		
		UsernamePasswordToken token=new UsernamePasswordToken(user.getName(), CryptographyUtil.md5(user.getPassword(), "huangqiuping"));
		try{
